...
declare module "@salesforce/schema/Contact.CKSW_BASE__Languages__c" {
  const CKSW_BASE__Languages__c:string;
  export default CKSW_BASE__Languages__c;
}
declare module "@salesforce/schema/Contact.CKSW_BASE__Level__c" {
