...
declare module "@salesforce/schema/Opportunity.Discount_Percentage__c" {
  const Discount_Percentage__c:number;
  export default Discount_Percentage__c;
}
declare module "@salesforce/schema/Opportunity.Discount__c" {
  const Discount__c:number;
  export default Discount__c;
}
declare module "@salesforce/schema/Opportunity.Discounted_Amount__c" {
  const Discounted_Amount__c:number;
  export default Discounted_Amount__c;
}
declare module "@salesforce/schema/Opportunity.Division_Manager_Email__c" {
...
declare module "@salesforce/schema/Opportunity.Predicted_Probability__c" {
