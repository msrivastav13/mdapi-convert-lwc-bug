...
declare module "@salesforce/schema/Case.CKSW_BASE__EngineeringReqNumber__c" {
  const CKSW_BASE__EngineeringReqNumber__c:string;
  export default CKSW_BASE__EngineeringReqNumber__c;
}
declare module "@salesforce/schema/Case.CKSW_BASE__PotentialLiability__c" {
  const CKSW_BASE__PotentialLiability__c:string;
  export default CKSW_BASE__PotentialLiability__c;
}
declare module "@salesforce/schema/Case.CKSW_BASE__Product__c" {
  const CKSW_BASE__Product__c:string;
  export default CKSW_BASE__Product__c;
}
declare module "@salesforce/schema/Case.CKSW_BASE__SLAViolation__c" {
  const CKSW_BASE__SLAViolation__c:string;
  export default CKSW_BASE__SLAViolation__c;
}
...
declare module "@salesforce/schema/Case.Incognito__ICS_Number__c" {
  const Incognito__ICS_Number__c:string;
  export default Incognito__ICS_Number__c;
}
declare module "@salesforce/schema/Case.Incognito__Serial_Number__c" {
  const Incognito__Serial_Number__c:string;
  export default Incognito__Serial_Number__c;
}
...
declare module "@salesforce/schema/Case.Related_Fridge__c" {
  const Related_Fridge__c:any;
  export default Related_Fridge__c;
}
declare module "@salesforce/schema/Case.Related_Fridge__r" {
  const Related_Fridge__r:any;
  export default Related_Fridge__r;
}
