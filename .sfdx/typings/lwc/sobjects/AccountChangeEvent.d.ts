...
declare module "@salesforce/schema/AccountChangeEvent.Active_Opportunity__c" {
  const Active_Opportunity__c:boolean;
  export default Active_Opportunity__c;
}
...
declare module "@salesforce/schema/AccountChangeEvent.Light__c" {
  const Light__c:string;
  export default Light__c;
}
