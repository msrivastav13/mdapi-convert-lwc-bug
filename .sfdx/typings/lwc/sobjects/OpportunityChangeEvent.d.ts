...
declare module "@salesforce/schema/OpportunityChangeEvent.CurrentGenerators__c" {
  const CurrentGenerators__c:string;
  export default CurrentGenerators__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.DeliveryInstallationStatus__c" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.Discount_Percentage__c" {
  const Discount_Percentage__c:number;
  export default Discount_Percentage__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Discount__c" {
  const Discount__c:number;
  export default Discount__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Discounted_Amount__c" {
  const Discounted_Amount__c:number;
  export default Discounted_Amount__c;
}
declare module "@salesforce/schema/OpportunityChangeEvent.Division_Manager_Email__c" {
  const Division_Manager_Email__c:string;
  export default Division_Manager_Email__c;
}
...
declare module "@salesforce/schema/OpportunityChangeEvent.MainCompetitors__c" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.OrderNumber__c" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.Predicted_Probability__c" {
  const Predicted_Probability__c:number;
  export default Predicted_Probability__c;
}
...
declare module "@salesforce/schema/OpportunityChangeEvent.Probability" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.SyncedQuote" {
  const SyncedQuote:any;
  export default SyncedQuote;
}
declare module "@salesforce/schema/OpportunityChangeEvent.SyncedQuoteId" {
...
declare module "@salesforce/schema/OpportunityChangeEvent.TrackingNumber__c" {
